...
\updateinfo[2026-04-11]{date of update: 2026-04-11 to version v1.1w}\label{up:20260411}

\begin{enumerate}

\item 根据2025国标修正gb7714-2025样式。(20260411)

Refine gb7714-2025 styles according to GB/T 7714-2025

\item 修正顺序编码制中citet在引用多篇文献时顺序编码标签不完全上标的问题。(20250625)

Correct the bug of incomplete superscript numeric label for citet in numeric styles when citing multiple references.

\item 修正报告类型中报告类型和报告号的位置。(20250627)

Correct the position of type and number for entrytype report.
...
\updateinfo[2025-06-10]{date of update: 2025-06-10 to version v1.1v}\label{up:20250610}
\begin{enumerate}

\item 增加尺寸 bibextramargin。(20250525)

add a length bibextramargin

\item 修改了文献表的段落格式设置参数。(20250525)

modify parameters of paragraph format for the bibliography

\item 增加法学引注手册样式chinese-molc。(20250610)

add the style chinese-molc for the manual of law citations.

\end{enumerate}

\updateinfo[2025-05-22]{date of update: 2025-05-22 to version v1.1u}\label{up:20250522}
\begin{enumerate}

\item 增加 gb7714-2025、gb7714-2025ay 样式。(20250522)

add styles: gb7714-2025, gb7714-2025ay

\item 增加booktitlecase等命令用于控制不同title的大小写。(20250519)

add commands like booktitlecase to control the case of titles such as booktitle.
...
\updateinfo[2025-03-03]{date of update: 2025-03-03 to version v1.1t}\label{up:20250303}
\begin{enumerate}
...
\updateinfo[2024-11-15]{date of update: 2024-11-15 to version v1.1s}\label{up:20241115}
\begin{enumerate}
...
\updateinfo[2024-05-15]{date of update: 2024-05-15 to version v1.1r}\label{up:20240515}
\begin{enumerate}
...
\updateinfo[2024-03-27]{date of update: 2024-03-27 to version v1.1q}\label{up:20240327}
\begin{enumerate}
